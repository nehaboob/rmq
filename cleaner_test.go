...
func (suite *CleanerSuite) TestCleaner(c *C) {
	...
	_, err = queue.Publish("del1")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(1))
	_, err = queue.Publish("del2")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(2))
	_, err = queue.Publish("del3")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(3))
	_, err = queue.Publish("del4")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(4))
	_, err = queue.Publish("del5")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(5))
	_, err = queue.Publish("del6")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	...
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(4))
	_, err = queue.Publish("del8")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(5))
	_, err = queue.Publish("del9")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
	c.Check(count, Equals, int64(6))
	_, err = queue.Publish("del10")
	c.Check(err, IsNil)
	count, err = queue.readyCount()
	c.Check(err, IsNil)
